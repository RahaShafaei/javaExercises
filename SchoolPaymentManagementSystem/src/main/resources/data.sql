...
VALUES (1, 1000, '2022-11-28', 1, 1, null),
       ...
       (9, 1700, '2022-12-04', 3, 9, null);
-- ==============================================
INSERT INTO PAYMENT (PAYMENT_ID, FEE_FEE_ID, SALARY_SALARY_ID,PAYMENT_DATE, COST)
VALUES (1, 1, null, '2022-11-26', 1000),
       (2, 2, null, '2022-11-28', 1000),
       (3, 3, null, '2022-12-30', 1500),
       (4, 6, null, '2022-12-01', 1700),
       (5, 9, null, '2022-12-03', 1700),
       (6, null, 1, '2022-11-26', 1000),
       (7, null, 2, '2022-11-28', 1000),
       (8, null, 3, '2022-12-30', 1500),
       (9, null, 6, '2022-12-01', 1700),
       (10, null, 9, '2022-12-04', 1700);
